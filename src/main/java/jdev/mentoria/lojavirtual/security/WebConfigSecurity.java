...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter implements HttpSessionListener {
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring()
				.antMatchers(HttpMethod.GET, "/salvarAcesso", "/deleteAcesso", "/deleteAcessoPorId/", "/obterAcesso/**",
						"/buscarPorDesc/**")

				.antMatchers(HttpMethod.POST, "/salvarAcesso", "/deleteAcesso", "/deleteAcessoPorId/",
						"/obterAcesso/**")

				.antMatchers(HttpMethod.DELETE, "/deleteAcessoPorId/");
